...
class ResultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create result" do
    assert_difference('Result.count') do
      post results_url, params: { result: { data: @result.data, run_id: @result.run_id, uuid: @result.uuid } }
    end
  ...
  test "should update result" do
    patch result_url(@result), params: { result: { data: @result.data, run_id: @result.run_id, uuid: @result.uuid } }
